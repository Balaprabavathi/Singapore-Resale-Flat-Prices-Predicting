...
icon='https://img.freepik.com/premium-photo/3d-rendered-photos-copper-logo-design-digital-design-company_1208590-44124.jpg'
st.set_page_config(page_title='Industrial copper',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by Balaprabavathi S'})
    ...
    if select == 'Selling Price':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('C:/Users/user/Desktop/Project env/Regressor.pkl','rb') as files:
    ...
    if select == 'Status':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('C:/Users/user/Desktop/Project env/Classifier.pkl','rb') as files:
